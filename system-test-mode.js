(()=>{
  ...
  function loadAdminSandbox(){
    ...
    if(!document.querySelector('script[data-admin-account-editor]')){const e=document.createElement('script');e.src='./admin-account-editor.js?v=2';e.defer=true;e.dataset.adminAccountEditor='1';document.head.appendChild(e)}
