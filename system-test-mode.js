(()=>{
  ...
  function loadAdminSandbox(){
    ...
    if(!document.querySelector('script[data-admin-ui-enhancements]')){const u=document.createElement('script');u.src='./admin-ui-enhancements.js?v=1';u.defer=true;u.dataset.adminUiEnhancements='1';document.head.appendChild(u)}
