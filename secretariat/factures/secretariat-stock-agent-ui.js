...
async function prepareAgent(){
  ...
  const result=await agentReq('prepare',{
    ...
    document_type:window.__secretariatDocumentType||'invoice',header_triple_agreement:window.__secretariatReaderCertified?.headerTriple===true,reader_version:22,items
  });
