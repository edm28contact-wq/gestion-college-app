...
async function prepareAgent(){
  ...
  const result=await agentReq('prepare',{
    ...
    document_type:window.__secretariatDocumentType||'invoice',header_triple_agreement:window.__secretariatReaderCertified?.headerTriple===true,header_consensus_agreement:window.__secretariatReaderCertified?.headerConsensus===true,reader_version:29,items
  });
